...
import { createRenderer, type CameraPreset } from './renderer';
...
export function createScene(container: HTMLElement, handlers: SceneHandlers): SceneApi {
  ...
  return {
    ...
    setCameraPreset: (preset) => renderer.setCameraPreset(preset),
    setCameraStage: (stage) => renderer.setCameraStage(stage),
  };
}
